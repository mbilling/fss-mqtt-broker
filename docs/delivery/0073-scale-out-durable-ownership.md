...
| 0073-T4.1 | ⬜ planned | [#565](https://github.com/mbilling/fss-mqtt-broker/issues/565) | — | "cargo land, €0, CI hours. The #390 grow hand-off race was found exactly this way (deterministically red under full-suite load); this stage exists so the next one like it costs CI minutes, not cluster money." |
