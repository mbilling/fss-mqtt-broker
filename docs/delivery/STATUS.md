...
| [0066](../adr/0066-threat-model-and-hardening-baseline.md) | Threat model, hardening baseline, and SIEM-consumable audit | Proposed | [2/3 done](0066-threat-model-and-hardening-baseline.md) | 1 open |
