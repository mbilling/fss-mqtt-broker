...
tasks:
  ...
  - id: 0014-T7
    ...
    status: deferred
    notes: ADR §3 leaves divergence unresolved — gap-fill keeps each side's own value; reconciling needs per-message timestamps / version vectors — an ADR-level design decision (retained-value versioning), queued as the next 0014 follow-on now that T6/T8 are done.
  - id: 0014-T8
...
| 0014-T7 | 💤 deferred | — | ADR §3 leaves divergence unresolved — gap-fill keeps each side's own value; reconciling needs per-message timestamps / version vectors — an ADR-level design decision (retained-value versioning), queued as the next 0014 follow-on now that T6/T8 are done. |
