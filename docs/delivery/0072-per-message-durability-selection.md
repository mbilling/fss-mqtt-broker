...
| 0072-T2 | ⬜ planned | [#563](https://github.com/mbilling/fss-mqtt-broker/issues/563) | — | "The ADR's alternatives note: an operator may want relaxed forbidden for some topics/principals even with the global opt-in on. Composes with T1; needs ACL surface design." |
<!-- /status-table:0072 -->
