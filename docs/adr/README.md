...
| [0019](0019-graceful-shutdown.md) | Graceful shutdown and connection draining | Accepted; implemented (v5 DISCONNECT, restart proofs, SWIM graceful leave; leader-transfer + QoS-settle deferred) |
