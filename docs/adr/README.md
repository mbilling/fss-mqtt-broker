...
| [0018](0018-on-disk-persistence.md) | On-disk persistence for durable state (Raft log, session log, retained) | Accepted; implemented (2 phase-5 validation items gated on ADR 0019) |
