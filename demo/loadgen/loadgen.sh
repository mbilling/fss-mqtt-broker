...
# Node list to wait for is injected by the compose file (generated by demo/scale-cluster.py)
# so scaling the cluster needs no edit here; falls back to the baseline three.
