...
Plaintext + anonymous: a first look, never a deployment. Secured version (TLS 1.3 + mTLS + ACL, CI-tested): [README](README.md#single-node-secured-tls-13--mtls--acl). Windows: [README](README.md#try-it-in-two-minutes).
