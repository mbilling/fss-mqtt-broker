...
/// Previous baselines: the `v1.0.0` release commit (`101554fc…` — the freeze
/// tag itself), and before it `v0.9.1` (`0f7042c2…`), which proved the roll
/// INTO the 1.0 line before the freeze tag was cut.
...
const BASELINE_REF: &str = "aa4739e18b9277b63e85328ff6a96a20aff9d8ac";
