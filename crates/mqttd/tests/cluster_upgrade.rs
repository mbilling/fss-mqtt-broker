...
/// Previous baselines: the `v1.0.1` release commit (`aa4739e1…`), before it
/// the `v1.0.0` release commit (`101554fc…` — the freeze tag itself), and
/// before that `v0.9.1` (`0f7042c2…`), which proved the roll INTO the 1.0
/// line before the freeze tag was cut.
...
const BASELINE_REF: &str = "ab73558123d8deeed96dac1963dcb921c687eeea";
