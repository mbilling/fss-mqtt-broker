...
/// Previous baselines: the `v1.0.5` release commit (`bf0bc1f9…`), before it
/// `v1.0.4` (`81658d62…`), `v1.0.3` (`e93bdc7b…`), `v1.0.2` (`ab735581…`),
/// `v1.0.1` (`aa4739e1…`), `v1.0.0` (`101554fc…` — the freeze tag itself),
/// and before that `v0.9.1` (`0f7042c2…`), which proved the roll INTO the 1.0
...
const BASELINE_REF: &str = "ea50bbb7e7e7cefe3d21a420ee95f975295b8ca3";
